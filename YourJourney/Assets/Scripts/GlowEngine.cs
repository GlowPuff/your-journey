...
public static class GlowExtensions
{
	...
	/// Change ONLY X
	/// </summary>
	public static Vector3 X( this Vector3 input, float xval )
	{
		return new Vector3( xval, input.y, input.z );
	}

	/// <summary>
	/// Change ONLY Y
	/// </summary>
	public static Vector3 Y( this Vector3 input, float yval )
	{
		return new Vector3( input.x, yval, input.z );
	}

	/// <summary>
	/// Change ONLY Z
	/// </summary>
	public static Vector3 Z( this Vector3 input, float zval )
	{
		return new Vector3( input.x, input.y, zval );
	}
...
public class GlowEngine : MonoBehaviour
{
	...
	/// <summary>
	/// Returns 0-based int[] array from 0 to max - 1, randomly assigned.
	/// </summary>
